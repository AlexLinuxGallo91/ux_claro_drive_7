...
class HtmlActions:
    ...
    @staticmethod
    def webdriver_wait_invisibility_of_element_located(web_driver, time=5, id=None, xpath=None, link_text=None,
                                               partial_link_text=None, name=None, tag_name=None, class_name=None,
                                               css_selector=None):
    ...
    @staticmethod
    def verificar_elemento_html_hasta_no_existir_en_el_dom_html(web_driver: WebDriver, time=5, id=None, xpath=None, link_text=None,
                                               partial_link_text=None, name=None, tag_name=None, class_name=None,
                                               css_selector=None):
    ...
    @staticmethod
    def webdriver_wait_until_not_invisibility_of_element_located(web_driver, time=5, id=None, xpath=None, link_text=None,
                                               partial_link_text=None, name=None, tag_name=None, class_name=None,
                                               css_selector=None):
